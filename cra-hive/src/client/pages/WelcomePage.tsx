...
export default function WelcomePage () {
    ...
    return <div>
        ...
        Unfortunately the mobile version of this site sucks. If you are on your phone please try it sometime on a bigger screen.
        <h2> The game Hive </h2>
        Hive is a abstract strategic board game designed by John Yianni
        and published by <Link to='https://www.gen42.com/games/hive'> Gen 42</Link>.
        If you want to know more about it <Link to='https://boardgamegeek.com/boardgame/2655/hive'>boardgamegeek</Link> is a good place to start.
